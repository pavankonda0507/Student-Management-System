...
export default function ProfileEditStudent({ student, onClose, getStudentByEmail}) {
                                ...
                                <form>
                                    <div className="row g-3 ">
                                        <div className="col-md-6">
                                            ...
                                            <input type="text" className="form-control" id="inputname" value={fullName} required onChange={(e) => { setFullName(e.target.value) }} disabled/>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <select id="inputgender" className="form-select" value={gender} required onChange={(e) => { setGender(e.target.value) }} disabled>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input type="email" className="form-control" id="inputemail" value={email} required onChange={(e) => { setEmail(e.target.value) }} disabled/>
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <input type="text" className="form-control" id="inputroll" value={rollNo} required onChange={(e) => { setRollNo(e.target.value) }} disabled/>
                                            {errors.rollNo && (<small className='text-danger'>{errors.rollNo}</small>)}
                                        </div>

                                        <div className="col-md-4">
                                            <label htmlFor="inputrole" className="form-label">Role Id</label>
                                            <select id="inputrole" className="form-select" required value={roleId} onChange={(e) => { setRoleId(e.target.value) }} disabled>
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <select id="inputbranch" className="form-select" value={branchId} required onChange={(e) => { setBranchId(e.target.value) }} disabled>
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <input type="number" className="form-control" id='inputpercentage' value={percentage} required onChange={(e)=>{ setPercentage(e.target.value)}} disabled/>
                                             {errors.percentage && (<small className='text-danger'>{errors.percentage}</small>)}
                                        </div>

                                        <div className="col-md-4">
                                            <label htmlFor="inputstatus" className='form-label'>Status</label>
                                            <select id="inputstatus" className="form-select" value={status} required onChange={(e) => { setStatus(e.target.value) }} disabled>
                                        ...
                                        <br />
                                        <i className="text-danger">Note: Kindly reach out to the Admin for any additional updates.</i>
